...
function Edit(_ref) {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps)(); //let pstgrid = wp.data.select('core').getEntityRecords('postType','post',{ _embed:true });
  ...
  const fetchPost = async () => {
    try {
      let data = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_4___default()({
        path: `/wp/v2/posts`
      }).then(res => {
